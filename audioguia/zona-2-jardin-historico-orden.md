# ZONA 2 — Jardín Histórico
## Orden físico provisional aportado por el proyecto

**Función:** recorrido histórico y paisajístico desde el Paseo de Plátanos hasta la Casa-Palacio y la antigua pista de tenis.  
**Continuación prevista:** enlazar desde aquí con el siguiente bloque, la Ruta de la Vuelta al Mundo en 80 Árboles.

## Orden de visita

1. Paseo de Plátanos.
2. Glorieta de Amalia Heredia.
3. Puente Carretero.
4. Teatrillo.
5. Busto de Amalia Heredia.
6. Fuente del Tritón.
7. Puente peatonal.
8. Kiosco oriental.
...
17. Gran Araucaria.
18. Camino ascendente hacia el Cenador.
19. Cascada de Piedra, parte superior y escondida de la caída de agua.
20. Canal de agua hacia el estanque de las Monsteras.
21. Estanque de las Monsteras con carpas.
22. Cenador de las Glicinias.
19. Casa-Palacio.
19. Patio interior, fuente central y elementos visitables de la Casa-Palacio.
20. Aseos de la Casa-Palacio.
21. Antigua pista de tenis.
22. Enlace con el siguiente bloque: Vuelta al Mundo en 80 Árboles.
...
### Ría de la Ninfa y cascada

La Ría debe incluir:

- Agua.
- Vegetación húmeda.
- Escultura de la Ninfa.
- Árboles y plantas del entorno.
- Cascada o caída de agua según la denominación exacta del punto.

Mantener pendientes:

- Nombre exacto de la cascada vinculada a esta zona.
- Autoría de la escultura.
- Nombre del árbol que provoca el cierre temporal de la zona.

### Árbol o fruto peligroso

El proyecto recuerda un árbol situado junto a la Ría cuyos frutos, semillas o piñas pueden ser muy cortantes al caer y provocar el cierre temporal del área en una época del año.

No identificarlo por intuición. Debe comprobarse:

- Nombre común.
- Nombre científico.
- Qué estructura es peligrosa: fruto, semilla, piña o cápsula.
- Época de caída.
- Medida de seguridad aplicada por el jardín.
...
La Cascada de Piedra aparece identificada con ese nombre en la fotografía histórica del jardín. Se encuentra en la parte superior y escondida del sistema de caída. La Cascada de Monsteras se ve justo después de cruzar el Puente de troncos desde la Fuente/Ría de la Ninfa, mirando a la izquierda.

Debe diferenciarse del **Estanque de Monsteras**, nombre que aparece en su cartel y que se encuentra al fondo del Cenador de las Glicinias, con peces carpas.

### Rodajes cinematográficos

La abundante vegetación tropical y el ambiente del jardín han convertido La Concepción en escenario de rodajes. Una comunicación científica de la Academia Malagueña de Ciencias documenta películas como:
...
- *Erik el Vikingo* (1965), entre otras referencias posteriores del estudio.

No se ha confirmado todavía que se rodara Tarzán en La Concepción. No mencionarlo hasta localizar una fuente específica.

Tratamiento recomendado:

> La frondosidad de La Concepción ha hecho que el jardín se utilice como escenario cinematográfico para representar lugares muy distintos: Cuba, Filipinas, India, islas tropicales o selvas imaginadas. La cámara puede convertir un mismo sendero en paisajes diferentes según el encuadre.

La referencia a películas puede ser una estación breve junto a la cascada o un audio de tránsito, sin convertir el jardín histórico en una explicación cinematográfica extensa.

## Posibles estaciones de audio

| Nº | Audio | Tipo | Contenido |
|---:|---|---|---|
| 1 | Paseo de Plátanos | Tránsito | Entrada al jardín histórico y árboles de sombra |
| 2 | Glorieta, Puente y Teatrillo | Estación | Perspectivas, vida social y busto de Amalia |
| 3 | Fuente del Tritón y puentes | Tránsito/estación breve | Agua, escultura y recorrido |
| 4 | González-Andreu y cipreses | Estación sensorial | Etapa pública, sombra y posible observación de ardillas |
| 5 | Ría, cascada y Ninfa | Estación | Agua, escultura y vegetación |
| 6 | Rodajes cinematográficos | Tránsito o estación breve | El jardín como escenario de selvas y países lejanos |
| 7 | Araucaria y Cenador | Estación | Árbol monumental, glicinia y arquitectura vegetal |
| 8 | Casa-Palacio y pista de tenis | Estación | Residencia, patio, servicios y vida social |
| 9 | Enlace a Vuelta al Mundo | Tránsito | Cambio desde jardín histórico a colección botánica global |

## Silencios recomendados

- Paseo de Plátanos: escucha durante el tránsito.
- Bosquete de cipreses: silencio para posible observación de fauna.
- Ría de la Ninfa: escucha del agua.
- Cascada: silencio posterior a la explicación.
...
- Confirmación de rodajes en el punto concreto de la cascada.
- Si la Casa-Palacio y sus aseos son el enlace más natural al siguiente bloque.
- Dirección exacta hacia la Vuelta al Mundo en 80 Árboles.


## Trabajo de campo — Paseo de Plátanos

- **Número del mapa general:** 3.
- **Acceso:** desde la entrada, tomar la carretera de arena compactada situada justo enfrente.
- **Dirección:** subida hacia el interior del Jardín Histórico.
- **Material visual:** fotografías remasterizadas y coloreadas de la época original, junto con panel informativo del paseo.
- **Referencias:** vista trasera hacia la entrada y vista frontal del paseo.

Las imágenes coloreadas deben presentarse como remasterizaciones de fotografías históricas, no como fotografías originalmente en color. Funcionan como recurso comparativo para mostrar cómo era el paseo en la etapa histórica.
...
- **Acceso confirmado:** después de la Gran Araucaria se toma el camino de la izquierda, en subida. Al encontrar una escalera a la derecha, se sube por ella hasta la Cascada de Piedra.
...
> Después de contemplar la Gran Araucaria, toma el camino de la izquierda y comienza a subir. Presta atención al lateral derecho: cuando encuentres una escalera que asciende entre la vegetación, síguela. La Cascada de Piedra está escondida y no aparece numerada en los mapas, por lo que tendrás que fijarte en el sonido del agua y en la escalera que se abre entre los árboles.

Este acceso sustituye a la indicación anterior que situaba el desvío antes de llegar al Cenador.


## Trabajo de campo — Cenador y Casa-Palacio

Después del Estanque de las Monsteras se atraviesa el Cenador de las Glicinias. En época de floración, la glicinia ofrece uno de los momentos visuales y aromáticos más destacados del jardín, por su color violeta y su perfume. En el extremo de salida del cenador hay un panel informativo y comienza el acceso hacia la Casa-Palacio.

La Casa-Palacio mantiene visitables el área de la biblioteca histórica, con una exposición de muebles originales de la casa y de la época, y el patio interior con su fuente central. En distintos elementos —estructuras, columnas, barandillas y escaleras— se observan marcas o firmas de la fábrica siderúrgica de los Heredia, según las fotografías de campo aportadas.

Tratamiento narrativo:

> Atraviesa el Cenador hasta su otro extremo. Si visitas La Concepción durante la floración, la glicinia convierte este paso en una bóveda violeta perfumada. Antes de continuar encontrarás el panel informativo del cenador. Desde allí nos dirigiremos a la Casa-Palacio, donde podrás ver la biblioteca histórica, la exposición de muebles y objetos originales y el patio interior con su fuente.
>
